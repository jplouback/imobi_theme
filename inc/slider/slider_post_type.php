...
// Create Custom Post Type
    ...
    function register_slides_posttype() {
        ...
        $post_type_args = array(
            ...
            'supports'          => $supports,
            'menu_position'     => 10, // Where it is in the menu. Change to 6 and it's below posts. 11 and it's below media, etc.
    ...
    // Meta Box for Slider URL ===============================
        ...
        function add_slidelink_2_meta_box() {
            ...
            foreach($slidelink_2_metabox['page'] as $page) {
                add_meta_box($slidelink_2_metabox['id'], $slidelink_2_metabox['title'], 'wp_show_slidelink_2_box', $page, 'normal', 'default', $slidelink_2_metabox);
            }
        }
         
        // function to show meta boxes
        function wp_show_slidelink_2_box()  {
            global $post;
            global $slidelink_2_metabox;
            ...
            echo '<input type="hidden" name="wp_slidelink_2_meta_box_nonce" value="', wp_create_nonce(basename(__FILE__)), '" />';
        ...
        function wptuts_slidelink_2_save($post_id) {
            ...
            // verify nonce
            if (!wp_verify_nonce($_POST['wp_slidelink_2_meta_box_nonce'], basename(__FILE__))) {
                return $post_id;
            }
